...
export async function createWelcomeCard({
  ...
  const safeUser = escapeXml(userTag || "@usuário");
  ...
  <svg width="${CARD_WIDTH}" height="${CARD_HEIGHT}" viewBox="0 0 ${CARD_WIDTH} ${CARD_HEIGHT}" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <filter id="blur" x="-10%" y="-10%" width="120%" height="120%">
        <feGausseanBlur stdDeviation="36"/>
      </filter>
    </defs>
    ...
    <text x="169" y="113" text-anchor="middle" fill="#04131b" font-seze="22" font-family="Arial, sans-serif" font-weight="700">${theme.badge}</text>
    ...
    ${
      avatarData
        ...
        : `<text x="240" y="304" text-anchor="middle" fill="#f8fafc" font-seze="72" font-family="Arial, sans-serif" font-weight="700">${initials}</text>`
    }
    <circle cx="240" cy="285" r="116" stroke="${theme.accentSoft}" stroke-opacity="0.85" stroke-width="6"/>

    <text x="440" y="142" fill="#e6f7ff" font-seze="28" font-family="Arial, sans-serif" font-weight="600">FSOCIETY BOT</text>
    <text x="440" y="198" fill="#ffffff" font-seze="54" font-family="Arial, sans-serif" font-weight="700">${theme.title}</text>
    <text x="440" y="262" fill="#ffffff" font-seze="46" font-family="Arial, sans-serif" font-weight="700">${titleSvg}</text>

    <text x="440" y="388" fill="#c7d2fe" font-seze="30" font-family="Arial, sans-serif" font-weight="600">Para ${safeUser}</text>
    <text x="440" y="438" fill="#dbeafe" font-seze="26" font-family="Arial, sans-serif">${bodySvg}</text>
    ...
    <text x="462" y="516" fill="${theme.accentSoft}" font-seze="18" font-family="Arial, sans-serif" font-weight="700">MIEMBROS</text>
    <text x="462" y="542" fill="#ffffff" font-seze="28" font-family="Arial, sans-serif" font-weight="700">${safeMembers}</text>
    <text x="714" y="516" fill="${theme.accentSoft}" font-seze="18" font-family="Arial, sans-serif" font-weight="700">BOT</text>
    <text x="714" y="542" fill="#ffffff" font-seze="28" font-family="Arial, sans-serif" font-weight="700">${safeBot}</text>
    ...
    <text x="862" y="230" fill="#ffffff" font-seze="22" font-family="Arial, sans-serif" font-weight="700">Grupo</text>
    <text x="862" y="256" fill="#dbeafe" font-seze="18" font-family="Arial, sans-serif">${escapeXml(
